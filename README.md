...
**PlasmoParrots** — это плагин для Paper и Plasmo Voice, который позволяет попугаям поблизости подслушивать фрагменты реальной речи игроков и повторять их забавными писклявыми «попугайскими» голосами.
