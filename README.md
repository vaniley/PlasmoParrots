...
**PlasmoParrots** — это плагин для Paper и Plasmo Voice (аадон к PlasmoVoice), который позволяет попугаям поблизости подслушивать фрагменты реальной речи игроков и повторять их забавными писклявыми «попугайскими» голосами.
