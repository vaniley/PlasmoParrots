...
Аудио хранится только в оперативной памяти на короткое время и никогда не записывается на диск. Плагин принимает звук только через штатную proximity-активацию Plasmo Voice после проверки её требований и не перехватывает общий поток сырых голосовых событий.
